...
/*
std::vector<double> check_distance(scene, cam: Vector, order, grnd)
    /*
    ...
    */
{
    ...
    for (item in cut(scene, order, cam, 3, 3))
    {
        ...
        dy = item[1] - cam.y;
        dz = item[2] - cam.z
            if (0 < dx <= 1.45 && abs(dy) <= 0.5 && abs(dz) <= 0.5)
            {
                ret[0] += 1;
            }
            else if (0 < dy <= 1.45 && abs(dx) <= 0.5 && abs(dz) <= 0.5)
            {
                ret[1] += 1;
            }
            else if (0 < dz <= 1.45 && abs(dx) <= 0.5 && abs(dy) <= 0.5)
            {
                ret[2] += 1;
            }
            else if (0 < -dx <= 1.45 && abs(dy) <= 0.5 && abs(dz) <= 0.5)
            {
                ret[3] += 1;
            }
            else if (0 < -dy <= 1.45 && abs(dx) <= 0.5 && abs(dz) <= 0.5)
            ...
            {
                if (np.sqrt((abs(dx) - 0.5) * (abs(dx) - 0.5) + (abs(dy) - 0.5) * (abs(dy) - 0.5)) <= 0.92 && abs(dz) <= 0.5)
                {
                    if (dx > 0)
                        ret[0] += 1;
                    else
                ...
                if (np.sqrt((abs(dx) - 0.5) * (abs(dx) - 0.5) + (abs(dz) - 0.5) * (abs(dz) - 0.5)) <= 0.92 && abs(dy) <= 0.5)
                {
                    if (dx > 0)
                        ret[0] += 1;
                    else
                ...
                if (np.sqrt((abs(dy) - 0.5) * (abs(dy) - 0.5)2 + (abs(dz) - 0.5) * (abs(dz) - 0.5)) <= 0.92 && abs(dx) <= 0.5)
                {
                    if (dy > 0)
                        ret[1] += 1;
                    else
            ...
            else if (np.sqrt((abs(dy) - 0.5) * (abs(dy) - 0.5) + (abs(dx) - 0.5) * (abs(dx) - 0.5) + (abs(dz) - 0.5) * (abs(dz) - 0.5)) <= 0.87)
            {
                if (dx > 0)
                    ret[0] += 1;
                else
